...
export const CATEGORIES = [
  {
    ...
    description: 'ISS, CSS and other crewed stations',
    groups: ['stations'],
  },
  {
    id: 'all',
    label: 'All Active',
    description: 'Every active satellite (large — thousands)',
    groups: ['active'],
  },
  {
    id: 'geo',
    label: 'Geostationary',
    description: 'Satellites in the geostationary belt',
    groups: ['geo'],
  },
  {
    id: 'starlink',
    label: 'Starlink',
    description: 'SpaceX Starlink constellation (large)',
    groups: ['starlink'],
  },
  {
    id: 'oneweb',
    label: 'OneWeb',
    description: 'OneWeb broadband constellation',
    groups: ['oneweb'],
  },
  {
    id: 'navigation',
  ...
  },
  {
    id: 'weather',
    label: 'Weather',
    description: 'Weather and environmental satellites',
